...
import Img5 from "../../../../../public/imgs/egypt.jpg";
import Image from "next/image";
async function DomesticTourism({ params: { lng } }) {
  const { t } = await useTranslation(lng, 'demosticTourism');
    ...
    <section className="section-elhag mb-32 overflow-hidden">
      ...
      <div className="bg-img  mt-[100px] relative h-[400px]">
        <Image
          ...
          objectFit="cover"
        />
        <div className="elhag-overlay w-[100%] absolute top-[30%]  xmd:h-[200px] md:h-[300px] flex items-center justify-center text-white bg-[#2121217a]">
