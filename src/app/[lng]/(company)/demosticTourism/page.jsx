...
<nav className="flex pt-5 justify-center" aria-label="Breadcrumb ">
  ...
  <ol className="inline-flex px-2 items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      ...
      <IoIosArrowForward/>
        <a href="#" className="ms-1 text-xl font-medium text-white hover:text-blue-200  md:ms-2 dark:text-gray-400 dark:hover:text-white">          {t('breadcrumb.domesticTourism')}</a>
      </div>
    </li>
